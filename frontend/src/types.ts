...
export interface TreeCatalogEntry { id: 'binary-search-tree'; name: 'Binary Search Tree'; family: 'TREE'; contractVersion: '2.0'; constraints: { kind: 'TREE'; minimumValues: 1; maximumValues: 31; minimumValue: number; maximumValue: number; uniqueValues: true; operations: Array<'PREORDER' | 'INORDER' | 'LOOKUP'> } }
